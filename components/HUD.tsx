  ...
  switch (type) {
    case 'audio':
      return {
        ...
        description: "ROXY needs to hear you to function. Voice data is processed in real-time.",
    ...
    case 'video':
      return {
        ...
        title: "Camera Access",
        description: "Enable vision so ROXY can see what you see. Allows for object recognition.",
        sub: "Optional • Vision",
    ...
    case 'overlay':
      return {
        ...
        description: "Allows ROXY to draw widgets on top of your screen for a true OS experience.",
